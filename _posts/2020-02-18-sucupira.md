...
- Internacionalização e visibilidade
  - Internacionalização:
    - Cooperação entre Instituições: 
      - [Université Le Havre Normandie]({% link _net/int-ulh2015.md %})
      - [Université catholique de Louvain]({% link _net/int-ucl2017.md
        %})
      - [Università degli studi di Roma 2 « Tor Vergata »]({% link
        _net/int-roma22019.md %})
